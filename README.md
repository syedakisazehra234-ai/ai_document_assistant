...
11. Save the secret.
12. Restart/redeploy the app if necessary.
...
1. The URL is a Google Drive file/folder URL.
2. The file or folder can be accessed by the app.
3. The document is PDF, DOCX, TXT or MD.
4. The Drive URL is not a restricted private resource that the app cannot access.
